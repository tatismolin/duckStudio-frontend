...
function Default(){
    ...
    return(
        <div className="loading-container">
            ...
            {/* <iframe width="560" height="315" src="https://www.youtube.com/embed/XEEasR7hVhA" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe> */}
        </div>
    );
